    ...
    <Layout>
      ...
      <div style={{ paddingTop: "10vh", textAlign: "justify" }}>
        <div style={{ textAlign: "center" }}>
          <TitleComponent title="Prestige Waterford Configuration" />
        </div>
        <div css={abn}>
          <span>
            Prestige Waterford is an up and coming extravagance private task
            ...
            shopping centers, schools, and workplaces. Glory Waterford is the
